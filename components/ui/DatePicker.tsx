  ...
  return (
    <div ref={pickerRef}>
      ...
      <div className={label ? "mt-1 relative" : "relative"}>
        ...
        {isOpen && (
          <div className={`absolute z-10 mt-1 rounded-lg shadow-lg overflow-hidden ${isDark ? 'dark-calendar bg-[#041b0f] border border-white/10' : 'bg-card border border-border'}`}>
            <Calendar
              date={selectedDate}
